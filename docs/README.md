...
사용자 인증, 커뮤니티 게시글, 실시간 기능(WebSocket), 챗봇 서빙 연동 등을 처리하는  
...
게시글 기반 커뮤니티 기능과 함께  
**WebSocket 기반 실시간 통신**, **Spring Security 인증**, **Redis 캐시**,  
**챗봇 서버 연동** 등을 적용하여 확장성과 유지보수성을 고려한 백엔드 아키텍처를 설계했습니다.
...
<p align="center">
  <img src="docs/images/post.png" width="60%">
</p>
...
<p align="center">
  <img src="docs/images/chatbot-architecture.png" width="800">
</p>
